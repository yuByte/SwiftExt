#
#  Be sure to run `pod spec lint SwiftExt.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "WeZZard"
  # s.authors            = { "WeZZard" => "wezzardlau@gmail.com" }
  # s.social_media_url   = "http://twitter.com/WeZZard"
  ...
  s.source       = { :git => "git@github.com:WeZZard/Swift-Extended-Library.git", :tag => s.version.to_s }
